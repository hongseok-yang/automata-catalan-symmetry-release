...
Section~\ref{sec:lean} describes the scope and status of the
machine-checked Lean formalisation of the paper's mathematical results. Finally,
...
$H$.  That $H$ is a bijection of each $\D_n$, and that it exchanges the two
statistics defined below, are known.  What is new is its computational status.
