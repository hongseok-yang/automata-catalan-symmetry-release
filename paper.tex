...
enter through the admitted axioms below.  The paper's numeric worked
...
its structural examples, such as the reverse-complement presented both as a
2DFT and as an $\MSO$ transduction, are not formalised.  Two documentation
