...
/-! ## Example 2.4 (`def:zeta`, paper-full-new.tex) -/
...
/-! ## Example 2.6 (`sec:dyck`, paper-full-new.tex) -/

/-- **`sec:dyck` (paper-full-new.tex).**
...
/-! ## Example 8.8 (`sec:narayana-sweep`, paper-full-new.tex): Narayana sweep on UUUDDD -/

/-- **`sec:narayana-sweep` (paper-full-new.tex).**
